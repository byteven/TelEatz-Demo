                    ...
                    <form action="{{ route('kelolamakanan.showdetail', $makanan->id) }}" method="GET"
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                @if ($makanan->img)
                                <img src="{{ $makanan->img_url }}" alt="{{ $makanan->nama_product }}"
                                ...
                                <div class="px-3">
                                    ...
                                    <div>
                                        <label class="mt-4" style="text-align: left;">Kategori</label>
                                        <input type="text" class="form-control" size="1000" name="harga"
                                            value="{{ $makanan->category?->nama_kategori ?? 'Tidak Ada' }}" required disabled>
                                    </div>
                                    <div>
