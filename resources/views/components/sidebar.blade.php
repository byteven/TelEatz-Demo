        ...
        <div class=" nav-2 sidebar-profile d-flex justify-content-start align-items-center py-3  px-3">
            ...
            <div class="nav-link ms-3" href="">
                <p id="username-sidebar" style="font-size: 17px;" class="fw-bold text-light text-capitalize">
                    {{ Auth::user()->name }}</p>
                <p style="font-size: 13px;" class="text-light text-capitalize">{{ auth::user()->role }} <i
                        class='bx bxs-check-shield p-0 m-0'></i></p>
            </div>

        </div>
        <a class="nav-link d-flex align-items-center gap-2" href="{{ route('buyer.dashboard') }}">
