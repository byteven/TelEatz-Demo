        ...
        <div class="d-flex d-lg-none align-items-center justify-content-between px-3 py-2 w-100">
            ...
            <a class="nav-link px-0" href="#">
                @if (Auth::check() && Auth::user()->img)
                    <img src="{{ Auth::user()->img_url }}" alt="Profil"
            ...
            <ul class="navbar-nav ms-auto d-flex justify-content-centera align-items-center">
                ...
                <div class="responsive-nav-drop d-lg-none mb-3 " style="border-radius: 25px; width: 80%;">
                    <li class="nav-item text-center border-2 text-light "
                        ...
                        <a class="nav-link px-0 text-light " href="{{ route('seller.dashboard') }}">Home</a>
                        <a class="nav-link px-0 text-light " href="{{ route('kelolamakanan') }}">Kelola Makanan</a>
                        <a class="nav-link px-0 text-light " href="{{ route(name: 'seller.pesanan') }}">Pesanan</a>
                        <a class="nav-link px-0 text-light " href="{{ route(name: 'seller.pesanan.history') }}">Histori Pesanan</a>
                        <a class="nav-link px-0 text-light " href="{{ route('seller.review') }}">Review</a>
                        <a class="nav-link px-0 text-light " href="{{ route('seller.profile') }}">Profile</a>
